	...
	<body>
		...
		<section id="film-poster">
			...
			<div class="text-center"><h2 class="page-header">Les films à l'affiche</h2></div>
				<div class="col-md-8">
<div class="title-section"><h3 class="title-section">A l'affiche</h3></div>
    ...
    <div class="item">
      <img class="img-responsive img-fit" src="/assets/img/film9.jpg" alt="cinema-stand3">
								...
								<div class="date">SORTIE LE 06 Mars</div>
									...
									<div class="description">Ce film-marathon se concentre sur la vie de trois parisiens d'une vingtaine d'années, qui vivent un ménage à trois peu conventionnel.</div>
								</div>
    </div>
  </div>
