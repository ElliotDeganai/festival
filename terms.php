		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<h2>Contenu</h2>
					<ul>
						<li><strong>Code de bonnes pratiques</strong></li>
						<li><strong>Introduction - Conditions générales :</strong></li>
						<li>
							Conditions générales :
							<ol>
								<li><strong>Définitions</strong></li>
								<li><strong>Étendue et définition de notre service</strong></li>
								<li><strong>Tarifs, tarifs barrés et « Nous ajustons nos tarifs ! »</strong></li>
								<li><strong>Confidentialité des informations et cookies</strong></li>
								<li><strong>Gratuit pour les consommateurs, seuls les Fournisseurs de Voyage paient !</strong></li>
								<li><strong>Carte de crédit ou virement bancaire</strong></li>
								<li><strong>Prépaiement, annulation, non-présentation et informations importantes</strong></li>
								<li><strong>Correspondances et communications (futures)</strong></li>
								<li><strong>Classement, programme de partenariat Établissements Préférés, étoiles et commentaires clients</strong></li>
								...
								<li><strong>À propos de Chalets&amp;Caviar et des bureaux locaux</strong></li>
							</ol>
						</li>
					</ul>
					<h2>Code de bonnes pratiques</h2>
					<p>
					...
					<ul>
						<li>Nous souhaitons que votre expérience soit optimale : nous vous proposons ainsi notre Plateforme et notre Service Clients dans plus de 40 langues</li>
						<li>Nous vous permettons d'explorer le monde : grâce à plus de 1,5 million d'établissements, du luxueux (luxueux) au fonctionnel, répondant à vos besoins, qu'il s'agisse d'un hôtel, d'un motel, d'une auberge de jeunesse ou encore d'un B&amp;B... partout dans le monde</li>
						<li>Nous mettons à votre disposition des attractions et autres Fournisseurs de Voyage</li>
						<li>Nous pouvons faciliter le paiement de tous frais (d'accès), achat ou location d'un produit et d'un service de Voyage utilisant notre service de paiement</li>
						<li>Nous vous assistons (24h/24 et 7j/7) : nos centres de Service Clients sont là pour vous 24-7-365-40+</li>
						<li>Nous sommes à votre écoute : notre Plateforme constitue un produit pratique qui correspond à VOS (celles des utilisateurs) préférences</li>
						<li>Nous vous laissons vous exprimer : nous affichons des commentaires non censurés (de clients qui ont réellement séjourné)</li>
						<li>Nous vous promettons un site Internet informatif et facile à utiliser, qui garantit les meilleurs tarifs disponibles</li>
						<li>Nous ajustons nos tarifs !</li>
					</ul>
					<h2>Introduction - Conditions générales :</h2>
					<p>
						Les présentes conditions générales d’utilisation, qui sont susceptibles d’être modifiées de façon ponctuelle, s’appliquent à tous nos services, directement ou indirectement (fournis par nos distributeurs) en ligne, via des appareils mobiles, par e-mail ou par téléphone. En accédant à notre site Internet (mobile) ou à toute autre application via une plateforme (ci-après dénommés collectivement la « Plateforme »), et/ou en y effectuant une réservation, vous déclarez avoir pris connaissance des présentes conditions générales d’utilisation et de notre charte de confidentialité, en comprendre la portée et les accepter.
					</p>
					<p>
						Les présentes pages, leur contenu et leur infrastructure, ainsi que le service de réservation en ligne (y compris la facilitation du service de paiement) fournis par nous via le présent site Internet appartiennent à, sont gérés par et sont fournis par Chalets&amp;Caviar B.V. Ils sont mis à votre disposition uniquement pour un usage personnel et non commercial (B2C), qui demeure soumis aux conditions générales d’utilisation établies ci-dessous. Notre relation avec les Fournisseurs de Voyage est régie par des conditions générales séparées qui régissent la relation commerciale (B2B) que nous avons avec chaque Fournisseur de Voyage. Tout Fournisseur de Voyage agit de façon professionnelle envers Chalets&amp;Caviar lorsqu'il s'agit de rendre leur produit ou service disponible sur ou via Chalets&amp;Caviar (à la fois dans le cadre de ses relations commerciales « B2B » et de ses relations non commerciales « B2C »). Veuillez noter que les Fournisseurs de Voyage peuvent détenir, déclarer applicables et nécessiter (l'acceptation de) leurs propres conditions générales (de prestation, d'expédition, de transport, d'utilisation) et règles de la maison pour l'utilisation, l'accès et la consommation du Voyage (qui pourrait comprendre certaines exclusions et limitations de responsabilité).
					</p>
					<h2>0. Définitions</h2>
					<p>
						« Chalets&amp;Caviar », « nous » ou « notre/nos » désigne Chalets&amp;Caviar B.V., une société privée à responsabilité limitée enregistrée aux Pays-Bas à cette adresse : Herengracht 597, 1017 CE, Amsterdam, Pays-Bas. « Plateforme » désigne le site Internet (mobile) et l'application sur lesquels le Service de Voyage est disponible, détenu, contrôlé, géré, alimenté et/ou hébergé par Chalets&amp;Caviar. « Voyage » désigne les différents produits et services de voyage que vous pouvez commander, acquérir, acheter, payer, louer, fournir, réserver, associer ou consommer auprès du Fournisseur de Voyage.
					</p>
					<p>
						« Fournisseur de Voyage » désigne le fournisseur de l'hébergement (par ex. l'hôtel, le motel, l'appartement, la chambre d'hôtes), des parcs (d'attractions), musées, visites touristiques, excursions en bateau, à pied ou en car, transferts), le tour-opérateur, les assurances et tout autre produit ou service lié au voyage rendu disponible de temps à autre sur la Plateforme pour une Réservation de Voyage (B2B ou B2C).
					</p>
					<p>
						« Service de Voyage » désigne le service de commande, d'achat, de paiement (facilité) ou de réservation en ligne des différents produits et services proposés ou rendus disponibles de temps à autre par les Fournisseurs de Voyages sur la Plateforme Chalets&amp;Caviar.
					</p>
					<p>
						« Réservation de Voyage » désigne la commande, l'achat, le paiement ou la réservation d'un Voyage.
					</p>
					<h2>1. Étendue et définition de notre service</h2>
					<p>
						À travers cette Plateforme, nous (Chalets&amp;Caviar B.V. et ses partenaires (de distribution) affiliés) fournissons un portail en ligne grâce auquel les Fournisseurs de Voyage peuvent proposer leurs produits et services à la commande, à l'achat, à la réservation ou à l'emploi, dans le cadre de leur étendue commerciale (par ex., B2B ou B2C), et grâce auquel les visiteurs de la Plateforme peuvent consulter, rechercher ou comparer les produits et services concernés et passer une commande, réserver ou encore effectuer un achat ou un paiement (pour le Service de Voyage choisi). En utilisant le Service de Voyage (par ex., en effectuant une Réservation de Voyage par l’intermédiaire du Service de Voyage), vous vous engagez dans une relation contractuelle directe avec le Fournisseur de Voyage auprès duquel vous avez effectué une réservation ou acheté un produit ou service (le cas échéant). À partir du moment où vous effectuez une Réservation de Voyage, nous agissons uniquement en qualité d’intermédiaire entre vous et le Fournisseur de Voyage, en transmettant les détails de votre réservation au(x) Fournisseur(s) de Voyage concerné(s) et en vous envoyant un e-mail de confirmation pour et au nom du Fournisseur de Voyage. Chalets&amp;Caviar ne (re)vend, loue ou propose aucun produit ou service (de voyage).
					</p>
					<p>
						Lors de la prestation de notre Service de Voyage, les informations que nous communiquons se fondent sur les informations que nous donnent les Fournisseurs de Voyage. Les Fournisseurs de Voyage qui proposent et promeuvent leurs produits et services de Voyage sur la Plateforme se voient donc donner l’accès à notre système ainsi qu'à notre extranet, grâce auquel ils détiennent l’entière responsabilité d’actualiser tous leurs tarifs/frais/prix, disponibilités, conditions et autres informations importantes affichées sur notre Plateforme. Bien que nous nous efforcions de fournir un Service de Voyage de qualité, nous ne pouvons ni vérifier, ni garantir l'exactitude, la précision ou l'exhaustivité des informations, et nous ne pouvons être tenus pour responsables d'aucune erreur (erreur manifeste ou faute typographique) ni interruption de service (due à une défaillance technique, qu’elle soit temporaire et/ou partielle ou qu'il s'agisse d'une panne, réparation, mise à jour, amélioration ou maintenance de notre Plateforme ou autre), d'aucune information imprécise, trompeuse ou erronée, ou bien d'un quelconque manque d’information. Chaque Fournisseur de Voyage demeure responsable à tout moment du caractère précis, complet et exact des informations (descriptives) qui le concernent et qui sont affichées sur notre Plateforme, y compris de ses tarifs/frais/pix, conditions et disponibilités. Notre Plateforme ne constitue pas et ne doit pas être considérée comme une quelconque forme de recommandation ou d’approbation de la qualité, du niveau de service ou du classement de chaque Fournisseur de Voyage (ou de ses équipements, attractions, véhicules, produits ou services principaux et secondaires) proposé aux visiteurs.
					</p>
					<p>
					...
					<p>
						Des tarifs inférieurs sont parfois disponibles sur notre Plateforme à certaines dates pour un séjour, produit ou service donné. Cependant, ces tarifs inférieurs proposés par les Fournisseurs de Voyage peuvent être soumis à des conditions et à des restrictions spécifiques, notamment en ce qui concerne les conditions d’annulation et de non-remboursement. Veuillez consulter avec attention les informations sur le produit, le service ou la réservation concerné(e) pour prendre connaissance desdites conditions avant d’effectuer votre réservation.
					</p>
					<p>
						Le tarif barré indiqué pour les hébergements est le troisième tarif le plus élevé pratiqué par le Fournisseur de Voyage, prenant en compte les mêmes conditions de réservation ou d'achat et sur une période de 30 jours autour de votre date d’arrivée ou de votre consommation du produit ou du service (15 jours avant et 15 jours après ; si la date d’arrivée ou de consommation est dans moins de 15 jours à compter d’aujourd’hui, nous prendrons en compte le nombre de jours correspondants après la date d’arrivée ou de consommation pour atteindre 30 jours au total). Afin que la comparaison soit équitable, nous prenons toujours en compte les mêmes conditions de Voyage (ex. : conditions d’annulation, produits auxiliaires tels que les repas et type de Voyage). Cela signifie que vous obtiendrez un tarif inférieur pour ce Voyage, comparé à d’autres dates d’arrivée ou de consommation au cours de la même période de l’année.
					</p>
					<p>
						Nous souhaitons vous faire bénéficier du meilleur tarif possible pour le produit ou service de votre choix. Après avoir réservé un produit ou un service sur notre Plateforme, si vous trouvez sur Internet, à un tarif inférieur, le même produit ou service aux mêmes conditions de Voyage, nous prenons en charge la différence entre le tarif affiché sur notre site et le tarif inférieur constaté sur un site concurrent, conformément aux conditions d’application de notre politique 
						<strong>Nous ajustons nos tarifs</strong>
						<strong> !</strong>
						. Cet engagement « Nous ajustons nos tarifs ! » ne s'applique pas à des produits et services non liés à des hébergements.
					</p>
					<p>
						Veuillez noter que le convertisseur de devises n’apparaît sur notre site qu’à titre indicatif. Il n’est en aucun cas représentatif des taux de change en vigueur au moment de la réservation.
					</p>
					<p>
					...
					<p>
						Les Fournisseurs de Voyage paient une commission (correspondant à un petit pourcentage du prix du produit (par ex. le tarif de l'hébergement)) à Chalets&amp;Caviar, versée après que le client a consommé le service ou le produit du Fournisseur de Voyage ou après que le client a séjourné chez (et payé) l’hébergeur. Les Fournisseurs de Voyage peuvent améliorer leur classement dans les résultats de recherche en augmentant leur commission (Accélérateur de visibilité). L'utilisation de l'Accélérateur de visibilité (en augmentant la commission en contrepartie d'une meilleure position dans le classement) se fait à la discrétion de chaque Fournisseur de Voyage, de temps à autre et selon le produit offert. L'algorithme du classement prendra en compte l'augmentation de la commission lorsqu'il déterminera le Classement par Défaut. Les partenaires préférés paient une commission plus élevée en échange d'une meilleure position dans le classement.
					</p>
					<p>
					...
					<p>
						Pour certains tarifs (non remboursables) ou offres spéciales, veuillez noter que les Fournisseurs de Voyage se réservent le droit de demander un paiement à l'avance par virement bancaire (si disponible) ou par carte de crédit et par conséquent une préautorisation de votre carte bancaire ou un prélèvement d'un certain montant (parfois sans possibilité de remboursement) sur cette même carte lors de la Réservation de Voyage. Avant d'effectuer votre Réservation de Voyage, veuillez consulter les détails (de la réservation) du produit ou service de votre choix pour prendre connaissance de telles conditions. Chalets&amp;Caviar ne pourra être tenue pour responsable de tout prélèvement (autorisé, (prétendument) non autorisé ou erroné) effectué par le Fournisseur de Voyage. Il ne vous sera pas possible de demander le remboursement de tout prélèvement valide ou autorisé par le Fournisseur de Voyage sur votre carte de crédit (y compris pour les tarifs avec prépaiement, les non-présentations et les annulations payantes).
					</p>
					<p>
					...
					<p>
						Chalets&amp;Caviar exclut toute responsabilité lors de communications avec le Fournisseur de Voyage sur ou via sa plateforme. Vous ne pouvez vous prévaloir d'aucun droit découlant des demandes ou communications avec le Fournisseur de Voyage ou de (toute forme d') accusé de réception de toute communication ou demande. Chalets&amp;Caviar ne peut garantir que toute demande ou communication sera (dûment et en temps utile) reçue/lue, acquittée, effectuée ou acceptée par le Fournisseur de Voyage.
					</p>
					<p>
						Afin de finaliser et garantir votre Réservation de Voyage comme il se doit, vous êtes tenu(e) d'utiliser votre bonne adresse e-mail. Nous excluons toute responsabilité (et ne sommes pas tenus de vérifier) toute adresse e-mail, numéro de téléphone, carte de crédit invalides ou mal renseignés.
					</p>
					<p>
						Toute plainte ou réclamation à l'encontre de Chalets&amp;Caviar ou liée au Service de Voyage doit être soumise rapidement, dans les 30 jours suivant le jour de la fin du produit ou service (par exemple, la date de départ de l'établissement). Toute plainte ou réclamation soumise après cette période de 30 jours pourra être rejetée et le demandeur pourra perdre le droit d'exiger une compensation (dommage ou coût).
					</p>
					<p>
						En raison des mises à jour et modifications effectuées régulièrement au niveau des tarifs et disponibilités, nous vous conseillons vivement de prendre des captures d'écran lorsque vous effectuez une réservation afin d'appuyer votre demande (le cas échéant).
					</p>
					<p>
						Nous vous recommandons de contacter notre Service Clients pour lui signaler toute réclamation. Si vous ne parvenez pas à résoudre le problème, vous pouvez ajouter votre réclamation sur la plateforme en ligne de règlement des litiges de la Commission européenne. Pour y accéder, cliquez ici : 
					...
					<p>
						Dans certaines villes ou régions, Chalets&amp;Caviar propose un programme de partenariat, permettant à certains Fournisseurs de Voyage respectant et maintenant les conditions de ce programme d’être listés avant les autres Fournisseurs de Voyage dans le Classement par défaut « Conseillés » de la ville/région. Les Fournisseurs de Voyage faisant partie de ce programme sont signalés par un symbole « Pouce en l’air ». En contrepartie de ce classement élevé, les Fournisseurs de Voyage concernés paient une commission plus importante. Seuls les Fournisseurs de Voyage qui respectent et maintiennent certains critères de sélection peuvent faire partie de ce programme.
					</p>
					<p>
						Les étoiles utilisées pour les établissements hors hôtels et résidences hôtelières (e.g. les chambres d’hôtes) ne correspondent pas au système de classement par étoiles applicable aux hôtels de tourisme.
					</p>
					<p>
						Seuls les clients ayant séjourné dans un Hébergement seront invités par Chalets&amp;Caviar à laisser un commentaire à son sujet et à donner une note sur certains aspects de leur séjour ou peuvent recevoir une demande d'évaluation au cours de leur séjour. Les commentaires (y compris ceux envoyés durant votre séjour) peuvent être (a) affichés sur notre Plateforme, sur la page du Fournisseur de Voyage concerné, dans le seul but d’informer les (futurs) clients des opinions sur le (niveau de) service et la qualité du Fournisseur de Voyage et (b) utilisés (partiellement ou dans leur totalité) par Chalets&amp;Caviar à sa seule discrétion (à des fins marketing ou promotionnelles ou pour améliorer nos services) sur notre Plateforme ou sur des réseaux sociaux, newsletters, offres spéciales, applications ou autre moyen utilisé, géré ou contrôlé par Chalets&amp;Caviar et nos partenaires commerciaux. Afin de proposer constamment des commentaires récents (et donc pertinents), les commentaires peuvent uniquement être laissés au cours d'une période limitée (28 jours) après la fin du séjour et seront également affichés pendant une période limitée (24 mois) après leur publication. Les commentaires sont affichés par défaut par date d’envoi. Le classement prend également d'autres critères en compte, comme la langue et la présence de texte accompagnant la note. Le commentaire d'un client qui écrit [toujours] des commentaires détaillés et complets (appelé Éclaireur) peut être placé en haut. Vous pouvez choisir différents classements grâce à des filtres (par exemple, par type de voyageurs, date, langue ou note). Chalets&amp;Caviar permet au Fournisseur de Voyage de répondre à un commentaire. Nous nous réservons le droit de normaliser, refuser ou supprimer tout commentaire à notre seule discrétion si celui-ci va à l'encontre de notre politique en matière de commentaires. Chalets&amp;Caviar n'indemnise ni ne récompense les clients laissant un commentaire. Le questionnaire de commentaires clients est considéré comme une enquête et, à ce titre, il ne comprend aucune offre commerciale, invitation ou publicité supplémentaire. Chalets&amp;Caviar s'engage à surveiller de son mieux et à supprimer les commentaires obscènes ou mentionnant le nom d'une personne ou faisant référence à des objets volés.
					</p>
					<p>
						Chalets&amp;Caviar n'accepte aucun commentaire :
					</p>
					<ul>
						<li>contenant des propos obscènes, discriminatoires, sexuellement explicites ou violents, haineux ou menaçants</li>
						<li>mentionnant des noms complets ou des insultes nominatives adressées au personnel</li>
						<li>faisant la promotion d'activités illégales (par ex. les drogues, la prostitution)</li>
						<li>mentionnant des sites Internet, e-mails et/ou des adresses, numéros de téléphone, coordonnées bancaires</li>
						<li>contenant des propos sensibles politiquement</li>
					</ul>
					<p>
					...
					<p>
						Néanmoins et sauf disposition d’ordre public nationale contraire, ni nous ni nos dirigeants, cadres, employés, représentants, filiales, affiliés, distributeurs, partenaires (de distribution), titulaires de sous-licences, agents ou autres personnes impliquées dans la création, le sponsoring, la promotion ou la mise à disposition du site et de ses contenus, ne pouvons être tenus responsables pour (i) toutes pertes ou tous dommages punitifs, spéciaux, indirects ou consécutifs, perte de production, perte de profit, perte de revenu, perte d’opportunité commerciale, perte ou atteinte à la marque ou à la réputation, ou bien perte du droit à indemnité ; (ii) toute inexactitude liée aux informations (descriptives) du Fournisseur de Voyage (y compris ses tarifs, ses disponibilités et son classement) mises à disposition sur notre Plateforme ; (iii) tous services fournis ou produits proposés par le Fournisseur de Voyage ou d’autres partenaires commerciaux ; (iv) tous dommages, pertes et coûts (punitifs, spéciaux, indirects ou consécutifs) soufferts, subis ou payés par vous, imputables à, découlant de ou liés à l’utilisation de notre Plateforme, de l’impossibilité de son utilisation ou de son ralentissement de fonctionnement ; ou (v) tout dommage corporel, décès, dommage aux biens ou autres dommages, pertes ou coûts (directs, indirects, spéciaux, consécutifs ou punitifs) soufferts, subis ou payés par vous, qu’ils soient dus à des actes (légaux), des erreurs, des manquements, une négligence (grave), une faute professionnelle délibérée, des omissions, une inexécution de contrat, des dénaturations des faits, au tort ou à la responsabilité objective attribuable (entièrement ou partiellement) au Fournisseur de Voyage ou à l'un de nos autres partenaires commerciaux (y compris ses employés, sa direction, ses responsables, ses agents, ses représentants, ses sous-traitants ou ses affiliés) dont les produits et services sont (directement ou indirectement) proposés ou promus sur ou via notre Plateforme, y compris toute annulation (même partielle), surréservation, grève, cas de force majeure ou autre événement indépendant de notre volonté.
					</p>
					<p>
						Chalets&amp;Caviar n'est pas responsable de (et décline toute responsabilité à cet égard) l'utilisation, la validité, la qualité, l’adéquation, la pertinence et la divulgation du Voyage, et n'assume aucune représentation, garantie ou condition à cet égard, qu'elles soient tacites, légales ou autres, y compris toute garantie implicite de qualité marchande, de titre, de non-contrefaçon ou de pertinence dans un but précis. Vous reconnaissez et acceptez l'entière responsabilité du Fournisseur de Voyage concerné dans le cadre du Voyage (y compris pour toute garantie et représentation assumée par le Fournisseur de Voyage). Chalets&amp;Caviar n'agit pas en tant que (re)vendeur du Voyage. Toute plainte ou réclamation concernant le Voyage (y compris relative au tarif (spécial/promotionnel) proposé, aux conditions ou aux demandes spéciales effectuées par le Client) sera traitée par le Fournisseur de Voyage. Chalets&amp;Caviar n'est pas responsable de ces plaintes et réclamations, ou du produit, et décline toute responsabilité à cet égard.
					</p>
					<p>
						Que le Fournisseur du Voyage vous facture (ou vous ait facturé) pour votre Voyage ou que nous facilitions le paiement du tarif ou des frais (du Voyage), vous reconnaissez et acceptez que le Fournisseur du Voyage est à tout moment responsable de la collecte, de la retenue, du versement et du paiement des taxes applicables dues sur le montant total du tarif ou des frais (du Voyage) aux autorités financières concernées. Chalets&amp;Caviar n’est ni responsable ni redevable du versement, de la collecte, de la retenue ou du paiement des taxes applicables concernées dues sur le tarif ou les frais (du Voyage) aux autorités financières concernées. Chalets&amp;Caviar n'agit pas en tant que commerçant pour les produits ou services disponibles sur la Plateforme.
					</p>
					<p>
					...
					<p>
						Chalets&amp;Caviar a son siège à Amsterdam, aux Pays-Bas, et est soutenue par différents bureaux locaux à travers le monde (les « Bureaux Locaux »). Les Bureaux Locaux n'assurent qu'un rôle de soutien interne pour et au nom de Chalets&amp;Caviar et certains d'entre eux proposent des services limités d'aide aux clients (uniquement par téléphone). Les Bureaux Locaux ne possèdent aucune Plateforme (et n'administrent pas, ni ne gèrent, n'hébergent ou ne maintiennent la Plateforme) et n'ont aucun pouvoir et autorité pour assurer le Service de Voyage, pour représenter Chalets&amp;Caviar ou pour entrer dans une relation contractuelle au nom de ou pour Chalets&amp;Caviar. Vous n'avez aucune relation (légale ou contractuelle) avec les Bureaux Locaux. Ceux-ci n'opèrent pas et ne sont pas autorisés à agir en tant qu'agent agréé ou représentant de service de Chalets&amp;Caviar. Chalets&amp;Caviar n'assume ni n'accepte aucune autre domiciliation dans tout autre lieu, endroit ou bureau dans le monde (ni dans ses bureaux locaux), que celle de son siège social à Amsterdam.
					</p>
					<p></p>
				</div>
			</div>
